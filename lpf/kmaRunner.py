...
class KMARunner():
    ...
    def check_for_kma(self):
        ...
        try:
            subprocess.call(["kma".format(str(Path.home()))], stdout=open(os.devnull, 'wb'))
    ...
    def run(self):
        """runs kma"""
        kma_cmd = "kma -t_db {} -i {} -o {} {}".format(str(Path.home()), self.reference_database, self.input, self.output, self.argument_string)
